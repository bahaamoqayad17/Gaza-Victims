...
import { AlertTriangle, ExternalLink, MapPin, ChevronDown, ChevronUp, Share2, Copy, Check, Download, Instagram, MessageCircle } from "lucide-react";
      ...
      <div className="flex gap-2 mt-2 mx-auto">
        ...
        <Button 
          ...
          onClick={() => {
            ...
            downloadAnchorNode.setAttribute("download", `case-${victim.id}.json`);
