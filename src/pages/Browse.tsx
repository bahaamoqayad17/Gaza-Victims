...
const cases = [
  ...
  },
  {
    ...
    lifeStory:
      "Ahmed was an engineer who spent his weekends volunteering at local shelters. His wife describes him as someone who 'always put others first.'",
    deathDetails:
      "Ahmed was caught in a missile strike while delivering aid to a residential building.",
  ...
  },
  {
    ...
    lifeStory:
      "Maria was a nurse who worked tirelessly during the conflict, often staying beyond her shifts to care for patients.",
    deathDetails:
      "Maria died when artillery shells hit the hospital where she worked. She refused to leave her patients behind.",
  ...
  },
  {
    ...
    lifeStory:
      "Chen was a university student studying journalism. He believed in the power of truth and was known for his courage.",
    deathDetails:
      "Chen was shot during a peaceful protest while documenting police actions with his camera.",
  ...
  },
  {
    ...
    lifeStory:
      "Elena was a doctor who volunteered at refugee camps. She was passionate about providing medical care to those in need.",
    deathDetails:
      "Elena died from exposure to chemical weapons during an attack on a medical facility.",
  ...
  },
  {
    ...
    lifeStory:
      "David was a local shop owner who helped distribute food and supplies to elderly residents during the siege.",
    deathDetails:
      "David was executed by occupying forces after being found helping civilians evacuate.",
  ...
  },
  {
    ...
    lifeStory:
      "Fatima was an art student who used her creativity to bring joy to children in refugee camps.",
    deathDetails:
      "Fatima was killed in her family home during a nighttime airstrike.",
  ...
  },
  {
    ...
    lifeStory:
      "Michael was a humanitarian worker who specialized in mine clearance. He had already saved countless lives.",
    deathDetails:
      "Michael was killed by an unmarked landmine while clearing a path to a school.",
  ...
  },
  {
    ...
    lifeStory:
      "Amira was a women's rights activist and teacher who continued to educate girls in secret.",
    deathDetails:
      "Amira was shot outside her home by unknown assailants after receiving death threats for her activism.",
  ...
  },
  {
    ...
    lifeStory:
      "Carlos was a community organizer who worked to improve living conditions in his neighborhood.",
    deathDetails:
      "Carlos was beaten to death during a peaceful protest demanding better living conditions.",
...
const Browse = () => {
  ...
  const filteredCases = cases
    .filter((victim) => {
      ...
      const matchesStatus =
        statusFilter === "all" || statusFilter === "thirdPartyVerified"
          ? victim.thirdPartyVerified
          : victim.status === statusFilter;
      const matchesCause =
        causeFilter === "all" || victim.causeOfDeath === causeFilter;
