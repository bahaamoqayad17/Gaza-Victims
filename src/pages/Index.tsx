...
const recentCases = [
  {
    ...
    lifeStory:
      "Sarah was a bright 8-year-old who loved painting and playing with her dolls. Her teacher remembers her as a curious child who always asked thoughtful questions. 'She wanted to be an artist when she grew up,' her mother recalls through tears.",
    deathDetails:
      "Sarah was killed during a bombing of her residential area. She was playing in her room when the attack occurred. Her family tried to reach the shelter but didn't make it in time.",
    familyRelationship:
      "left behind her mother, father, and two younger brothers",
  ...
  },
  {
    ...
    lifeStory:
      "Ahmed was an engineer who spent his weekends volunteering at local shelters. His wife describes him as someone who 'always put others first.' He had been planning to start a family and dreamed of building sustainable housing.",
    deathDetails:
      "Ahmed was caught in a missile strike while delivering aid to a residential building. Witnesses report he was helping evacuate elderly residents when the second wave of attacks hit the area.",
  ...
  },
  {
    ...
    lifeStory:
      "Maria was a nurse who worked tirelessly during the conflict, often staying beyond her shifts to care for patients. Her daughter remembers her saying, 'Healing is the only way to fight darkness.' She loved gardening and classical music.",
    deathDetails:
      "Maria died when artillery shells hit the hospital where she worked. She was in the intensive care unit attending to critical patients when the attack began. She refused to leave her patients behind.",
  ...
  },
  {
    ...
    lifeStory:
      "Chen was a university student studying journalism. He believed in the power of truth and was known for his courage in standing up for justice. His friends describe him as someone who never backed down from doing what was right.",
    deathDetails:
      "Chen was shot during a peaceful protest while documenting police actions with his camera. Witnesses say he was clearly identified as press but was targeted nonetheless.",
  ...
  },
  {
    ...
    lifeStory:
      "Elena was a doctor who volunteered at refugee camps. She was passionate about providing medical care to those in need and often worked without pay to help families escape conflict zones.",
    deathDetails:
      "Elena died from exposure to chemical weapons during an attack on a medical facility. She was treating patients when the attack occurred and refused to abandon them.",
  ...
  },
  {
    ...
    lifeStory:
      "David was a local shop owner who helped distribute food and supplies to elderly residents during the siege. His neighbors remember him as a kind man who always helped others, even when resources were scarce.",
    deathDetails:
      "David was executed by occupying forces after being found helping civilians evacuate. His body was discovered with his hands tied behind his back.",
  ...
  },
  {
    ...
    lifeStory:
      "Fatima was an art student who used her creativity to bring joy to children in refugee camps. She taught art classes and organized cultural events to help preserve Palestinian heritage.",
    deathDetails:
      "Fatima was killed in her family home during a nighttime airstrike. The building collapsed, trapping her and several family members inside.",
  ...
  },
  {
    ...
    lifeStory:
      "Michael was a humanitarian worker who specialized in mine clearance. He had already saved countless lives by safely removing unexploded ordnance from civilian areas.",
    deathDetails:
      "Michael was killed by an unmarked landmine while clearing a path to a school. He died instantly, but his work had already made the surrounding area safe for children to return.",
  ...
  },
  {
    ...
    lifeStory:
      "Amira was a women's rights activist and teacher who continued to educate girls in secret after schools were closed. She believed education was the key to freedom and never stopped fighting for women's rights.",
    deathDetails:
      "Amira was shot outside her home by unknown assailants. She had received death threats for her activism but refused to leave the country, saying her work was too important.",
  ...
  },
  {
    ...
    lifeStory:
      "Carlos was a community organizer who worked to improve living conditions in his neighborhood. He organized food distribution programs and advocated for basic services like clean water and electricity.",
    deathDetails:
      "Carlos was beaten to death during a peaceful protest demanding better living conditions. Multiple witnesses identified the officers involved, but no arrests have been made.",
              ...
              <div className="text-center mb-8">
                <div className="text-sm text-muted-foreground">
                  <div className="flex flex-wrap justify-center items-center gap-2 md:gap-4">
                    ...
                    >
                      <span className="font-bold text-2xl">2,847</span> Total
                      Cases
                    </Link>
