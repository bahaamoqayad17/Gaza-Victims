            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-1">
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setTimelineScrollPosition(Math.max(0, timelineScrollPosition - 1))}
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setTimelineScrollPosition(Math.min(timelineData.length - 1, timelineScrollPosition + 1))}
                  disabled={timelineScrollPosition >= timelineData.length - 1}
                  className="hidden md:flex h-6 w-6 p-0"
                >
