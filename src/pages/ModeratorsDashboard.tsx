...
const ModeratorsDashboard = () => {
  ...
  const filteredModerators = moderators.filter((mod) => {
    ...
    const matchesStatus =
      selectedStatus === "all" || mod.status === selectedStatus;
                  ...
                  <TableBody>
                    {filteredModerators.map((moderator) => (
                      <TableRow key={moderator.id}>
                        <TableCell>
                          <div className="flex items-center space-x-3">
                            <Avatar className="h-8 w-8">
                              <AvatarImage
                                src={`https://api.dicebear.com/6.x/initials/svg?seed=${moderator.name}`}
                              />
                              <AvatarFallback>
                                {moderator.name
                                  .split(" ")
                        ...
                        <TableCell>
                          <Badge
                            variant={getStatusBadgeVariant(moderator.status)}
                          >
                            {moderator.status}
                          </Badge>
                        </TableCell>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm">
                        Requires 2 moderator approvals
                      </span>
                    </div>
                  </div>
